void Pioes_Muoes_Outras_Detetor0(){

TFile *ficheiro = new TFile("AmberTarget_Run_0.root","READ");						//Reads a file
       TFile *ficheiroGravar = new TFile("Analise_Pioes_Muoes_0.root","RECREATE");			//Saves a file
       TTree *dados = (TTree*) ficheiro->Get("tracksData");						//TTree - List of independent columns or branches, represented by the TBranch class
        ...
        Histograma_Pioes->SetFillColor(2);
        ...
        Histograma_Muoes->SetFillColor(50);
        ...
        dados->Draw("EdepDet0_keV>>Histograma_Outras","particlePDG!=13 || particlePDG!=-13 || particlePDG!=211 || particlePDG!=-211");
        Histograma_Outras->SetFillColor(45);
        Histograma_Outras->Write();
        Histograma_Outras->SetTitle("Outras - Detetor0 ; log(EdepDet0_keV)");
        gPad->SetLogy();
